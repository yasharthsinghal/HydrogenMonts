...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center font-medium tracking-wide transition-all duration-150 ease-out active:scale-[0.97] active:brightness-95 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:pointer-events-none disabled:active:scale-100 rounded-[6px] cursor-pointer';
