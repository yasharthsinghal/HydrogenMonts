...
import type { VariantInventoryData } from './inventorySnapshot.server';
...
export function auditCartLines(
  ...
  for (const line of lines) {
    ...
    // If snapshot doesn't have the variant (e.g. deleted variant), evaluate with line merchandise info
  ...
  // Checkout is allowed only if no items are completely out of stock
